<template>
  <div class="msite">
            ...
            <a>
              ...
              <div class="shop_right">
                <section class="shop_detail_header">
                  <h4 class="shop_title" >{{shop.title}}</h4>
                  <ul class="shop_detail_ul">
                    <li class="supports" v-for="item in shop.nameList">{{item.value}}</li>
                    &lt;!&ndash;<li class="supports">准</li>
                    <li class="supports">票</li>&ndash;&gt;
                  </ul>
                </section>
                <section class="shop_rating_order">
                  ...
                  <section class="shop_rating_order_right">
                    <span class="delivery_style delivery_left">{{shop.value3}}</span>
                    <span class="delivery_style delivery_right">{{shop.value4}}</span>
                  </section>
                </section>
                <section class="shop_distance">
                  <p class="shop_delivery_msg">
                    <span>{{shop.value5}}</span>
                    <span class="segmentation">/</span>
                    <span>{{shop.value6}}</span>
                  </p>
                </section>
              </div>
            </a>
          </li>
          &lt;!&ndash;<li class="shop_li border-1px">
            <a>
              <div class="shop_left">
   ...
   <!-- <HeaderTop title="昌平区北七家镇">
      <router-link slot="search" class="header_search"  to="/search">
        <i class="iconfont icon-sousuo"></i>
      </router-link>
      <router-link slot="login" class="header_search"  to="/login">
